...
// Set templates.
$controller->set_templates( [ 'single/single-' . $post->ID . '.twig', 'single/single-' . $post->post_type . '.twig', 'single/single.twig' ] );

// If this is a password protected page we render the single password template.
if ( post_password_required( $post->ID ) ) {
	$controller->set_templates( [ 'single/single-password.twig' ] );
}
