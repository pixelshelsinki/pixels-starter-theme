 ...
 */
 Twig.extendFunction("responsive_image", function(id, mobileImage, desktopImage) {
  return `printed image of id ${id} and sizes ${mobileImage} & ${desktopImage}`
})

Twig.extendFunction("responsive_background", function(id, mobileImage, desktopImage, selector) {
  return `printed background image of id ${id} and sizes ${mobileImage} & ${desktopImage} with selector ${selector}`
})
